...
class _HomeParentPageState extends State<HomeParentPage> {
  ...
  List<Map<String, dynamic>> data = [
    {
      'title': 'KRS',
      'sub_title': 'Kartu Rencana Studi',
      'icon': Icons.format_list_numbered_rounded,
      'to': const KrsPage(),
      'to_name': RouteName.KRS,
    },
    {
      'title': 'Jadwal',
      'sub_title': '',
      'icon': Icons.calendar_month_outlined,
      'to': const SchedulePage(),
      'to_name': RouteName.SCHEDULE,
    },
    {
      'title': '',
      'sub_title': 'Catatan Perkembangan Santri',
      'icon': Icons.note_alt_outlined,
      'to': const ProgressNotePage(),
      'to_name': RouteName.ACHIVEMENT,
    },
    {
      'title': 'KPU',
      'sub_title': 'Kartu Peserta Ujian',
      'icon': Icons.assignment_ind_outlined,
      'to': const KpuPage(),
      'to_name': RouteName.KPU,
    },
    {
      'title': 'Transkrip',
      'sub_title': '',
      'icon': Icons.note_sharp,
      'to': const TranscriptPage(),
      'to_name': RouteName.TRANSCRIPT,
    },
    {
      'title': 'KHS',
      'sub_title': 'Kartu Hasil Studi',
      'icon': Icons.insert_chart_outlined_rounded,
      'to': const KhsPage(),
      'to_name': RouteName.KHS,
    },
  ];
