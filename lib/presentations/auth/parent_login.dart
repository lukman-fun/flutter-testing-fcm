...
import 'package:testing/presentations/auth/parent_register.dart';
...
void parentRegister(BuildContext context) {
  showModalBottomSheet(
    ...
    builder: (context) {
      return const ParentRegisterPage();
    },
  );
}
